...
const createDensityOverlays = () => {
    ...
    const densityLayers = [
        { minDensity: 0, maxDensity: 0.20, color: 'rgba(255, 130, 90, 0.55)', chars: " .'`^\",:;Il!i" },
        { minDensity: 0.20, maxDensity: 0.70, color: 'rgba(255, 45, 58, 1)', chars: "><~+_-?][}{1)(|\\/tfjrxnuvczXYUJCLQ0" },
        { minDensity: 0.70, maxDensity: 1.0, color: 'rgba(150, 12, 22, 1)', chars: "Zmwqpdbkhao*#MW&8%B@$" }
    ];
